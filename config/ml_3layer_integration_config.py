...
CONFIG_3LAYER = {
    "enabled": True,  # ✅ RÉACTIVÉ 25/11/2025 - Fonctionnait vendredi
    "mode": "production",  # "production" ou "testing"

    # ✅ MODIFIÉ CALIBRAGE 18/11: Seuils ultra-permissifs (-50 à -63%)
    "min_thresholds": {
        "menthorq": 0.10,    # ✅ MODIFIÉ: 0.20 → 0.10 (-50%)
        "orderflow": 0.05,   # ✅ MODIFIÉ: 0.12 → 0.05 (-58%)
        "context": 0.03,     # ✅ MODIFIÉ: 0.08 → 0.03 (-63%)
        "total": 0.25        # ✅ MODIFIÉ: 0.50 → 0.25 (-50%)
    },
...
CONFIG_MARKET_CONTEXT = {
    ...
    # ✅ MODIFIÉ CALIBRAGE 18/11: Pré-filtre ultra-permissif
    "prefilter": {
        "min_quality_score": 0.20,        # ✅ MODIFIÉ: 0.40 → 0.20 (-50%)
        "max_proximity_alerts": 10         # ✅ MODIFIÉ: 3 → 10 (plus permissif)
    },

    # ✅ MODIFIÉ CALIBRAGE 18/11: Post-validation permissive
    "postvalidation": {
        "reject_opposite_bias": False,    # ✅ MODIFIÉ: True → False (accepter contre-tendance en calibrage)
