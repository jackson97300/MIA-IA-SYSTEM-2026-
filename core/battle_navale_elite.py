...
class BattleNavaleElite:
    ...
    def calculate_battle_navale_elite(self, dom_data: Dict[str, Any], orderflow_data: Dict[str, Any], 
        ...
        try:
            ...
            dom_health, dom_gate = self._calculate_dom_health(dom_data, symbol)
    ...
    def _calculate_orderflow_advanced(self, trade_summary_data: Dict[str, Any], 
        ...
        imb_mag, dir_ok = self._calculate_volume_imbalance_directional(trade_summary_data, intended_direction)
    ...
    def _calculate_sierra_patterns(self, pattern_scores: Dict[str, Tuple[float, float]]) -> float:
        ...
        # Score de base
        patterns = sum(weight * score for pattern, (weight, score) in pattern_scores.items())
        
        # Bonus pour patterns multiples
        active_n = sum(1 for _, (_, score) in pattern_scores.items() if score > 0.5)
        ...
        # Cap final
        patterns = min(1.0, patterns * bonus)
