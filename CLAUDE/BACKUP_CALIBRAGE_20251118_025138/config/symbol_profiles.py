...
#         min_total_conf_base=0.35 + CONFIDENCE_ADJUSTMENT,  # ← Production 35%
        min_total_conf_base=0.30 + CONFIDENCE_ADJUSTMENT,  # MODE CALIBRAGE - Assoupli a 30%
#         min_layer1_conf=0.25,  # ← Production 25%
        min_layer1_conf=0.22,  # MODE CALIBRAGE - Assoupli a 22%
#         min_layer2_conf=0.18,  # ← Production 18%
        min_layer2_conf=0.15,  # MODE CALIBRAGE - Assoupli a 15%
#         min_layer3_conf=0.12,  # ← Production 12%
        min_layer3_conf=0.10,  # MODE CALIBRAGE - Assoupli a 10%

        # Risk
        max_size_usd=500.0,  # $500 risque max par trade
#         default_sl_ticks=18,  # ← Production: 18 ticks = $225
        default_sl_ticks=20,  # MODE CALIBRAGE - Elargi a $250
#         default_tp_ticks=20,  # ← Production: 20 ticks = $250
        default_tp_ticks=22,  # MODE CALIBRAGE - Elargi a $275
...
#         min_total_conf_base=0.28 + CONFIDENCE_ADJUSTMENT,  # ← Production 28%
        min_total_conf_base=0.25 + CONFIDENCE_ADJUSTMENT,  # MODE CALIBRAGE - Assoupli a 25%
#         min_layer1_conf=0.27,  # ← Production 27%
        min_layer1_conf=0.24,  # MODE CALIBRAGE - Assoupli a 24%
#         min_layer2_conf=0.20,  # ← Production 20%
        min_layer2_conf=0.17,  # MODE CALIBRAGE - Assoupli a 17%
#         min_layer3_conf=0.13,  # ← Production 13%
        min_layer3_conf=0.11,  # MODE CALIBRAGE - Assoupli a 11%

        # Risk
        max_size_usd=450.0,  # $450 risque max
#         default_sl_ticks=15,  # ← Production: 15 ticks = $75
        default_sl_ticks=18,  # MODE CALIBRAGE - Elargi a $90
#         default_tp_ticks=30,  # ← Production: 30 ticks = $150
        default_tp_ticks=36,  # MODE CALIBRAGE - Elargi a $180
